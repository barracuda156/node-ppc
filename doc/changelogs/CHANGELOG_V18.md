...
## 2022-09-05, Version 18.9.0 (Current), @RafaelGSS

### Notable changes

* **cli**
  * (SEMVER-MINOR) add `--watch` (Moshe Atlow) <https://github.com/nodejs/node/pull/44366>
* **doc**
...
* \[[`ad29b118aa`](https://github.com/nodejs/node/commit/ad29b118aa)] - **build**: go faster, drop -fno-omit-frame-pointer (Ben Noordhuis) [#44452](https://github.com/nodejs/node/pull/44452)
...
* \[[`05d608747e`](https://github.com/nodejs/node/commit/05d608747e)] - **(SEMVER-MINOR)** **cli**: add `--watch` (Moshe Atlow) [#44366](https://github.com/nodejs/node/pull/44366)
...
* \[[`98c43a1119`](https://github.com/nodejs/node/commit/98c43a1119)] - **crypto**: handle invalid prepareAsymmetricKey JWK inputs (Filip Skokan) [#44475](https://github.com/nodejs/node/pull/44475)
* \[[`285cd2ce96`](https://github.com/nodejs/node/commit/285cd2ce96)] - **crypto**: add digest name to INVALID\_DIGEST errors (Tobias Nießen) [#44468](https://github.com/nodejs/node/pull/44468)
* \[[`092664200e`](https://github.com/nodejs/node/commit/092664200e)] - **crypto**: use actual option name in error message (Tobias Nießen) [#44455](https://github.com/nodejs/node/pull/44455)
...
* \[[`d912d2d66f`](https://github.com/nodejs/node/commit/d912d2d66f)] - **deps**: update corepack to 0.14.0 (Node.js GitHub Bot) [#44509](https://github.com/nodejs/node/pull/44509)
* \[[`913c5232b2`](https://github.com/nodejs/node/commit/913c5232b2)] - **deps**: upgrade npm to 8.19.1 (npm team) [#44486](https://github.com/nodejs/node/pull/44486)
* \[[`7aaca9850c`](https://github.com/nodejs/node/commit/7aaca9850c)] - **deps**: V8: backport ff8d67c88449 (Michaël Zasso) [#44423](https://github.com/nodejs/node/pull/44423)
* \[[`0bd8e9da2c`](https://github.com/nodejs/node/commit/0bd8e9da2c)] - **deps**: update Acorn to v8.8.0 (Michaël Zasso) [#44437](https://github.com/nodejs/node/pull/44437)
...
* \[[`725b4fd045`](https://github.com/nodejs/node/commit/725b4fd045)] - **doc**: add missing parenthesis in TLSSocket section (Tobias Nießen) [#44512](https://github.com/nodejs/node/pull/44512)
* \[[`84b5c9e8d5`](https://github.com/nodejs/node/commit/84b5c9e8d5)] - **doc**: do not use "Returns:" for crypto.constants (Tobias Nießen) [#44481](https://github.com/nodejs/node/pull/44481)
* \[[`cb98864e6f`](https://github.com/nodejs/node/commit/cb98864e6f)] - **doc**: use serial comma in addons docs (Tobias Nießen) [#44482](https://github.com/nodejs/node/pull/44482)
* \[[`5c70cbed30`](https://github.com/nodejs/node/commit/5c70cbed30)] - **doc**: add --update-assert-snapshot to node.1 (Colin Ihrig) [#44429](https://github.com/nodejs/node/pull/44429)
* \[[`eedd223d28`](https://github.com/nodejs/node/commit/eedd223d28)] - **doc**: improve assert.snapshot() docs (Colin Ihrig) [#44429](https://github.com/nodejs/node/pull/44429)
* \[[`ab5ab3300f`](https://github.com/nodejs/node/commit/ab5ab3300f)] - **doc**: add missing imports in events sample code (Brian Evans) [#44337](https://github.com/nodejs/node/pull/44337)
* \[[`af2890141b`](https://github.com/nodejs/node/commit/af2890141b)] - **doc**: apply scroll-margin-top to h2, h3 elements (metonym) [#44414](https://github.com/nodejs/node/pull/44414)
...
* \[[`602c46fec5`](https://github.com/nodejs/node/commit/602c46fec5)] - **(SEMVER-MINOR)** **lib**: add diagnostics channel for process and worker (theanarkh) [#44045](https://github.com/nodejs/node/pull/44045)
...
* \[[`4b683686b8`](https://github.com/nodejs/node/commit/4b683686b8)] - **meta**: update AUTHORS (Node.js GitHub Bot) [#44511](https://github.com/nodejs/node/pull/44511)
...
* \[[`b0d4431f94`](https://github.com/nodejs/node/commit/b0d4431f94)] - **node-api**: avoid calling virtual methods in base's dtor (Chengzhong Wu) [#44424](https://github.com/nodejs/node/pull/44424)
...
* \[[`86b3951dcb`](https://github.com/nodejs/node/commit/86b3951dcb)] - **report**: get stack trace with cross origin contexts (Chengzhong Wu) [#44398](https://github.com/nodejs/node/pull/44398)
* \[[`95258bd7b0`](https://github.com/nodejs/node/commit/95258bd7b0)] - **report**: fix missing section javascriptHeap on OOMError (Chengzhong Wu) [#44398](https://github.com/nodejs/node/pull/44398)
...
* \[[`a19f62ffae`](https://github.com/nodejs/node/commit/a19f62ffae)] - **src**: rename misleading arg in ClientHelloParser (Tobias Nießen) [#44500](https://github.com/nodejs/node/pull/44500)
* \[[`110869416a`](https://github.com/nodejs/node/commit/110869416a)] - **src**: improve error handling in CloneSSLCerts (Tobias Nießen) [#44410](https://github.com/nodejs/node/pull/44410)
* \[[`be1d9c619a`](https://github.com/nodejs/node/commit/be1d9c619a)] - **src**: fix incorrect comments in crypto (Tobias Nießen) [#44470](https://github.com/nodejs/node/pull/44470)
* \[[`217170a001`](https://github.com/nodejs/node/commit/217170a001)] - **src**: avoid casting std::trunc(... / ...) to size\_t (Tobias Nießen) [#44467](https://github.com/nodejs/node/pull/44467)
* \[[`a020f9608e`](https://github.com/nodejs/node/commit/a020f9608e)] - **(SEMVER-MINOR)** **src**: expose environment RequestInterrupt api (Chengzhong Wu) [#44362](https://github.com/nodejs/node/pull/44362)
* \[[`2a28a77f2c`](https://github.com/nodejs/node/commit/2a28a77f2c)] - **src**: simplify enable\_if logic of `ToStringHelper::BaseConvert` (Feng Yu) [#44306](https://github.com/nodejs/node/pull/44306)
* \[[`f578b54c76`](https://github.com/nodejs/node/commit/f578b54c76)] - **src**: add error handling to `uv_uptime` call (Juan José Arboleda) [#44386](https://github.com/nodejs/node/pull/44386)
* \[[`fbc2aec9de`](https://github.com/nodejs/node/commit/fbc2aec9de)] - **src**: remove base64\_select\_table and base64\_table (Tobias Nießen) [#44425](https://github.com/nodejs/node/pull/44425)
* \[[`02a67fbf1f`](https://github.com/nodejs/node/commit/02a67fbf1f)] - **src**: fix uv\_err\_name memory leak (theanarkh) [#44421](https://github.com/nodejs/node/pull/44421)
* \[[`31e41c15d9`](https://github.com/nodejs/node/commit/31e41c15d9)] - **src**: make Endianness an enum class (Tobias Nießen) [#44411](https://github.com/nodejs/node/pull/44411)
* \[[`24344ce132`](https://github.com/nodejs/node/commit/24344ce132)] - **src**: remove v8abbr.h (Tobias Nießen) [#44402](https://github.com/nodejs/node/pull/44402)
...
* \[[`ebb43a6f61`](https://github.com/nodejs/node/commit/ebb43a6f61)] - **stream**: fix setting abort reason in `ReadableStream.pipeTo()` (Daeyeon Jeong) [#44418](https://github.com/nodejs/node/pull/44418)
...
* \[[`f803d38a61`](https://github.com/nodejs/node/commit/f803d38a61)] - **test**: avoid race in file write stream handle tests (Joyee Cheung) [#44380](https://github.com/nodejs/node/pull/44380)
* \[[`5dfea4d6d4`](https://github.com/nodejs/node/commit/5dfea4d6d4)] - **test**: style updates for assert.snapshot() (Colin Ihrig) [#44429](https://github.com/nodejs/node/pull/44429)
* \[[`7f15fb7d17`](https://github.com/nodejs/node/commit/7f15fb7d17)] - **test**: deflake child process exec timeout tests (Joyee Cheung) [#44390](https://github.com/nodejs/node/pull/44390)
* \[[`aeaea85bd8`](https://github.com/nodejs/node/commit/aeaea85bd8)] - **test**: make the vm timeout escape tests more lenient (Joyee Cheung) [#44433](https://github.com/nodejs/node/pull/44433)
* \[[`6e1abf4b10`](https://github.com/nodejs/node/commit/6e1abf4b10)] - **test**: split heap prof tests (Joyee Cheung) [#44388](https://github.com/nodejs/node/pull/44388)
* \[[`fcd2075182`](https://github.com/nodejs/node/commit/fcd2075182)] - **test**: fix multiple incorrect mustNotCall() uses (Tobias Nießen) [#44022](https://github.com/nodejs/node/pull/44022)
...
* \[[`d135ab5791`](https://github.com/nodejs/node/commit/d135ab5791)] - **test\_runner**: fix `duration_ms` to be milliseconds (Moshe Atlow) [#44450](https://github.com/nodejs/node/pull/44450)
...
* \[[`e475514561`](https://github.com/nodejs/node/commit/e475514561)] - **tools**: update lint-md-dependencies to rollup\@2.79.0 (Node.js GitHub Bot) [#44510](https://github.com/nodejs/node/pull/44510)
