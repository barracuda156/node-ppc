...
#define UNIMPLEMENTED_PPC()
    ...
    !V8_OS_MACOS && (!defined(_CALL_ELF) || _CALL_ELF == 1)))
#define ABI_USES_FUNCTION_DESCRIPTORS 1
#else
#define ABI_USES_FUNCTION_DESCRIPTORS 0
#endif

#if !(V8_HOST_ARCH_PPC || V8_HOST_ARCH_PPC64) || V8_OS_AIX || V8_OS_MACOS || \
...
#if !(V8_HOST_ARCH_PPC || V8_HOST_ARCH_PPC64) || (!V8_TARGET_ARCH_PPC64 && !V8_OS_MACOS) || \
