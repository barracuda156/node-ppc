...
#if !(V8_HOST_ARCH_PPC || V8_HOST_ARCH_PPC64) || V8_OS_AIX || V8_OS_MACOSX || V8_TARGET_ARCH_PPC64
...
#if !V8_OS_MACOSX // Darwin does not use TOC
#if !(V8_HOST_ARCH_PPC || V8_HOST_ARCH_PPC64) || V8_OS_AIX || V8_TARGET_ARCH_PPC64
